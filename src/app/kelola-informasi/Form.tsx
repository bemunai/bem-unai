...
export default function Form({ prevData }: { prevData?: PrevData }) {
    ...
    return (
        <form onSubmit={handleSubmit} className="w-full max-w-lg">
            ...
            <button type="submit" className="w-full mt-5 bg-gradient-to-r from-secondary to-[#FFFF] text-primary px-4 py-2 rounded-xl transition duration-300 transform hover:scale-105 hover:from-[#ffff] hover:to-secondary hover:text-black">
