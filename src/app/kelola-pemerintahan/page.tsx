...
export default async function page() {
  ...
  return (
    <main className="container mx-auto p-4 my-16  flex flex-col items-center pt-20">
      ...
      <Link
        href="/kelola-pemerintahan/create"
        className="mb-5 bg-gradient-to-r from-secondary to-[#ffff] text-primary px-4 py-2 rounded-xl transition duration-300 transform hover:scale-105 hover:from-[#ffff] hover:to-secondary hover:text-black"
      >
              ...
              allOrganisasi.map((organisasi: OrganisasiProps) => (
                <tr key={organisasi.id}>
                  ...
                  <td>
                    ...
                    organisasi.description.length > 40
                      ? `${organisasi.description.substring(0, 80)}...`
                      : organisasi.description}
                    <br />
                  ...
                  <td>
                    <Link
                      href={`/pemerintahan/${organisasi.abbreviation}`}
                      className="text-xs hover:underline"
                    >
                      details
                    </Link>
                    <Link
                      href={`/kelola-pemerintahan/edit/${organisasi.abbreviation}`}
