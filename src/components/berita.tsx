...
export default async function Berita() {
  ...
  return (
    <section className="flex flex-col items-center mx-auto p-4 mt-16 mb-32">
      ...
      <Link
        href={"/berita"}
        className="bg-gradient-to-r from-secondary to-[#ffff] text-primary px-4 py-2 mt-2 rounded-full transition duration-300 transform hover:scale-105 hover:from-[#ffff] hover:to-secondary hover:text-black"
      >
        Baca Selengkapnya
      </Link>
    </section>
